...
CREATE TABLE `loyalty` (
  `loyalty_id` varchar(11) NOT NULL,
  `user_id` varchar(11) NOT NULL,
  `loyalty_point` int(11) NOT NULL,
  `discount_rate` int(2) NOT NULL,
  `loyalty_created` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
--
...
ALTER TABLE `loyalty`
  ADD CONSTRAINT `loyalty_fk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE;
COMMIT;
